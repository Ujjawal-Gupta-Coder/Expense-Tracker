...
const Heading = ({headline}) => {
  return (
    <div className='text-5xl md:text-6xl lg:text-7xl text-center font-bold bg-clip-text flex flex-col flex-wrap items-center text-transparent bg-gradient-to-r from-rose-500 from-30% via-orange-400 via-40% to-green-400 group step-1'>
