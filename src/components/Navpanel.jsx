  ...
  return (
    <div className='fixed md:hidden top-[70px] w-full h-full z-10'>
     <ul className='text-2xl bg-slate-800 pt-12 w-full h-full flex flex-col items-center gap-y-10  text-white'>
          ...
          <a href='https://ujjawal-gupta-coder.github.io/My-Portfolio/' className='border-2 border-red-600 px-4 py-2 w-fit text-xl font-patrick font-bold rounded-lg bg-gradient-to-tr from-purple-700 to-slate-600 hover:from-purple-900 hover:to-slate-900 hover:-translate-y-2 transition'>✨ Meet The Developer</a>
    </ul>
    </div>
